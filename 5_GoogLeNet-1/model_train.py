...
def train_val_data_process():
    ...
    ROOT = r'./data/train'
    # 定义归一化方法
    normalize = Normalize(mean=[0.162, 0.151, 0.138], std=[0.058, 0.052, 0.047])
    # 定义数据集处理方法变量
    train_transforms = Compose([Resize((224, 224)), ToTensor(), normalize])

    # 加载数据集
    data = ImageFolder(root=ROOT, transform=train_transforms)
